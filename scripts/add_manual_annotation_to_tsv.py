...
if __name__ == '__main__':
    ...
    parser.add_argument(
            '-j', metavar='FILE', type=str, dest='json_file', required=True,
            help='json file containing manual annotations')
    parser.add_argument(
            '-p', metavar='FILE', type=str, dest='pool',
            required=True, help='tsv file containing unannotated data')
    parser.add_argument(
            '-set', metavar='FILE', type=str, dest='set_file', required=False,
            default=None, help='tsv file containing train/test/dev-set')
