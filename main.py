...
if __name__ == '__main__':
    ...
    parser.add_argument(
            '-train', metavar='FILE', type=str, dest='train', required=True,
            help='tsv file containing training set')
    parser.add_argument(
            '-dev', metavar='FILE', type=str, dest='dev', required=True,
            help='tsv file containing dev set')
    parser.add_argument(
            '-test', metavar='FILE', type=str, dest='test', required=True,
            help='tsv file containing test set')
    parser.add_argument(
            '-pool', metavar='FILE', type=str, dest='unannotated',
            required=True, help='tsv file containing unannotated data')
    parser.add_argument(
            '-unseen', metavar='FILE', type=str, dest='unseen', required=False,
            default=None, help='tsv file containing unseen data')
